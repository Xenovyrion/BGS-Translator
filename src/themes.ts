...
export const THEME_PRESETS: ThemePreset[] = [
  // ── Dark (default) ────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-recoverable": "#818cf8",
      "--modal-backdrop":   "rgba(0,0,0,0.55)",
      "--highlight-match":  "rgba(253,224,71,0.35)",
    },
  },
  ...
  // ── Clair ─────────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-recoverable": "#7c3aed",
      "--modal-backdrop":   "rgba(0,0,0,0.45)",
      "--highlight-match":  "rgba(253,224,71,0.55)",
    },
  },
  ...
  // ── Nord ──────────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-unchanged":   "#7c8fa6",
      "--diff-recoverable": "#b48ead",
      "--modal-backdrop":   "rgba(0,0,0,0.6)",
      "--highlight-match":  "rgba(235,203,139,0.35)",
    },
  },
  ...
  // ── Dracula ───────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#50fa7b",
      "--diff-removed":     "#ff5555",
      "--diff-modified":    "#ffb86c",
      "--diff-unchanged":   "#6272a4",
      "--diff-recoverable": "#ff79c6",
      "--modal-backdrop":   "rgba(0,0,0,0.6)",
      "--highlight-match":  "rgba(253,224,71,0.35)",
    },
  },
  ...
  // ── Catppuccin ────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#a6e3a1",
      "--diff-removed":     "#f38ba8",
      "--diff-modified":    "#fab387",
      "--diff-unchanged":   "#7f849c",
      "--diff-recoverable": "#f5c2e7",
      "--modal-backdrop":   "rgba(0,0,0,0.6)",
      "--highlight-match":  "rgba(253,224,71,0.3)",
    },
  },
  ...
  // ── Ocean ─────────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-unchanged":   "#2d6fa0",
      "--diff-recoverable": "#e879f9",
  ...
  // ── Forest ────────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#86efac",
      "--diff-removed":     "#f87171",
      "--diff-modified":    "#fde047",
      "--diff-unchanged":   "#4b7255",
      "--diff-recoverable": "#a78bfa",
      "--modal-backdrop":   "rgba(0,0,0,0.65)",
      "--highlight-match":  "rgba(253,224,71,0.35)",
    },
  },
  ...
  // ── Tokyo Night ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#9ece6a",
      "--diff-removed":     "#f7768e",
      "--diff-modified":    "#e0af68",
      "--diff-unchanged":   "#565f89",
      "--diff-recoverable": "#bb9af7",
      "--modal-backdrop":   "rgba(0,0,0,0.65)",
      "--highlight-match":  "rgba(253,224,71,0.3)",
    },
  },
  ...
  // ── Solarized ─────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-unchanged":   "#586e75",
      "--diff-recoverable": "#d33682",
      "--modal-backdrop":   "rgba(0,0,0,0.65)",
      "--highlight-match":  "rgba(253,224,71,0.3)",
    },
  },
  ...
  // ── Gruvbox ───────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#b8bb26",
      "--diff-removed":     "#fb4934",
      "--diff-modified":    "#fe8019",
      "--diff-unchanged":   "#928374",
      "--diff-recoverable": "#d3869b",
      "--modal-backdrop":   "rgba(0,0,0,0.65)",
      "--highlight-match":  "rgba(253,224,71,0.35)",
    },
  },
  ...
  // ── Monokai ───────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-unchanged":   "#75715e",
      "--diff-recoverable": "#ae81ff",
      "--modal-backdrop":   "rgba(0,0,0,0.65)",
      "--highlight-match":  "rgba(253,224,71,0.35)",
    },
  },
  ...
  // ── Rose Pine ─────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--diff-added":       "#31748f",
      "--diff-removed":     "#eb6f92",
      "--diff-modified":    "#f6c177",
      "--diff-unchanged":   "#6e6a86",
      "--diff-recoverable": "#eb6f92",
      "--modal-backdrop":   "rgba(0,0,0,0.6)",
      "--highlight-match":  "rgba(253,224,71,0.3)",
    },
  },
